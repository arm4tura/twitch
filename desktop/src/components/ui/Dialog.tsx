    ...
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 " +
            "rounded-card border border-white/10 bg-surface shadow-card p-6 " +
            "animate-slide-up",
          className
        )}
        {...props}
      >
        ...
        <DialogPrimitive.Close
          className="absolute right-4 top-4 rounded p-1 text-muted transition-colors hover:bg-white/10 hover:text-fg
